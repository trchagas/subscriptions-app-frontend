<template>
  <div>
    ...
    <Container @drop="onDropQuestion($event)">
      <Draggable v-for="(question, index) in material.evaluation" :key="index">
        <card shadow type="secondary mb-3">
                ...
                <h3 class="mb-0">
                  ...
                  <span class="float-right">
                    <base-button
                      ...
                      size="sm"
                      class="text-primary"
                      @click="handleRemoveQuestions(index)"
                    >
                    ...
                    <span
                      v-tooltip="'Visualizar/ocultar detalhes'"
                      class="ml-2"
                    >
                      <i
                        class="fas fa-angle-down"
                        @click="question.showDetails = !question.showDetails"
                      />
                    </span>
                  </span>
                </h3>
          ...
          <div v-show="question.showDetails">
              ...
              <div class="col-lg-6">
                <label class="form-control-label">
                  ...
                  <i
                    ...
                    "
                    class="fas fa-info-circle ml-lg-1"
                  />
                </label>
                <p>
            ...
            <div
              v-if="
                question.type === 'radiobox' || question.type === 'checkbox'
              "
            >
              <div class="row ml-lg-1">
                <div class="col-12">
            ...
            <div
              v-if="
                question.type === 'checkbox' && question.right_answer.length
              "
            >
              <div class="row ml-lg-1">
                <div class="col-12">
            ...
            <div
              v-if="
                question.type === 'radiobox' && question.right_answer.length
              "
            >
              <div class="row ml-lg-1">
                <div class="col-12">
...
export default {
  ...
  methods: {
    ...
    handleRemoveOptions(index) {
      ...
      if (this.model.questions.right_answer[index])
        this.model.questions.right_answer[index] = false;
    },
    ...
    onDropQuestion(dropResult) {
      const { removedIndex, addedIndex } = dropResult;
      var questoes = this.material.evaluation;
      let draggingMaterial = this.material.evaluation[removedIndex];
      if (removedIndex === addedIndex) return;
      if (removedIndex !== null) {
        questoes.splice(removedIndex, 1);
      }
      if (addedIndex !== null) {
        questoes.splice(addedIndex, 0, draggingMaterial);
      }
    },
