              ...
              <form ref="voluntario_form" role="form" class="vld-parent">
                ...
                <div class="row ml-lg-2">
                  <div class="col-lg-6">
                    ...
                    >
                      <p>{{ model.voluntario.name }}</p>
                    </base-input>
                  </div>
                  <div class="col-lg-6">
                    <base-input label="Área" placeholder="Digite a atuação">
                      <p>{{ model.voluntario.working_area }}</p>
                    </base-input>
                  </div>
                  <div class="col-lg-6">
                    <base-input label="Sexo biológico">
                      <p>{{ genderLabels[model.voluntario.gender] }}</p>
                    </base-input>
                  </div>
                  <div class="col-lg-6">
                ...
                >
                  <div class="col-lg-6">
                    <base-input label="CPF do voluntário">
                      <p v-if="model.voluntario.cpf">
                        {{ formatCPF(model.voluntario.cpf) }}
                      </p>
                  ...
                  <div class="col-lg-6">
                    ...
                    >
                      <p v-if="model.voluntario.specialty">
                        {{ model.voluntario.specialty }}
                      </p>
                  ...
                  <div class="col-lg-6">
                    ...
                    >
                      <p v-if="model.voluntario.birth">
                        {{ formatDate(model.voluntario.birth) }}
                      </p>
                  ...
                  <div class="col-lg-6">
                    ...
                    <base-input
                      ...
                      placeholder="Data de nascimento"
                    >
                      <p v-if="model.voluntario.start_at">
                        {{ formatDate(model.voluntario.start_at) }}
                      </p>
                      <p v-else>Não informada</p>
                    </base-input>
                  </div>
                  <div class="col-lg-12">
                    <base-input label="Biografia">
                      <textarea
                        ...
                        rows="2"
                        class="form-control"
                        placeholder="Breve biografia do voluntário"
                      />
                    </base-input>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    async handleSubmitForm(e) {
      ...
      try {
        await api.put(
          `/volunteer/volunteers/${this.model.voluntario.user_id}`,
          {
            short_bio: this.model.voluntario.short_bio,
            phone: this.model.voluntario.phone,
          }
        );
    ...
    async handleSubmitProfilePicture() {
      ...
      try {
        await api.post(
          `/volunteer/users/${this.model.voluntario.user_id}/profile-pictures`,
          data,
          config
        );
    ...
    async handleSubmitChangePassword() {
      ...
      try {
        await api.put(
          `/volunteer/users/${this.model.voluntario.user_id}/change-password`,
          this.model.user
        );
