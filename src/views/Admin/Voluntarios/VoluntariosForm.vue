      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-12 mt-0 mt-md-4 mt-lg-0 d-block">
            <router-link
              :to="'/diretoria/usuarios/voluntarios'"
          ...
          <div class="col-lg-7 col-md-10">
            <p class="text-white mt-4 mb-2">
              Aqui é possível cadastrar um novo voluntário ao sistema. Por
              ...
              perfil de voluntário do portal.
            </p>
          </div>
        </div>
      </div>
          ...
          <card shadow type="secondary">
            <div slot="header" class="bg-white border-0">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">
                    <i class="fas fa-users mr-2" /> Novo voluntário
                  </h3>
                </div>
              </div>
            </div>
    ...
    >
      ...
      <div ref="modal_confirmation" class="vld-parent">
        <div class="py-3 text-center">
          ...
          <p class="mt-3 mb-0">
            ...
            <span class="font-weight-bold">voluntário</span> do portal.
          </p>
          <p class="mt-3">
            Por favor, digite
      ...
      <template slot="footer">
        ...
        <base-button
          ...
          @click="handleSubmitNewVoluntario"
        >
          Confirmar criação
        </base-button>
      </template>
...
export default {
  ...
  async mounted() {
    ...
    if (this.$route.query.user_id) this.loadTeacher();
  },
  methods: {
    validEmail() {
    ...
    async loadTeacher() {
      ...
      try {
        ...
        if (
          !this.registeredTypes.includes(this.model.voluntario.working_area)
        ) {
          this.other = true;
          this.extraType = this.model.voluntario.working_area;
        }
    ...
    async loadUsers() {
      ...
      try {
        const { data } = await api.get(
          "admin/users?table=teachers&except=volunteers"
        );
    ...
    async handleSubmitNewVoluntario(e) {
      e.preventDefault();
      const loader = this.$loading.show({
        container: this.$refs.modal_confirmation,
        width: 90,
      ...
      try {
        await api.post("/admin/volunteers", {
          ...userData,
          password_confirmation: this.model.user.password,
          ...voluntario,
        });
        this.$toasted.show("Novo voluntário cadastradro com sucesso");
        this.$router.push("/diretoria/usuarios/voluntarios");
      } catch (e) {
        const genericError = "Ocorreu um erro ao cadastrar o voluntário.";
        const hasErrorResponseData = e.response && e.response.data;
        let customError = genericError;
        if (hasErrorResponseData) {
          const data = e.response.data;
