      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-12 mt-0 mt-md-4 mt-lg-0 d-block">
            <router-link
              :to="'/diretoria/usuarios/associados'"
          ...
          <div class="col-lg-7 col-md-10">
            <p class="text-white mt-4 mb-2">
              Aqui é possível cadastrar um novo associado ao sistema. Por
          ...
          <card shadow type="secondary">
            <div slot="header" class="bg-white border-0">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">
                    <i class="fas fa-users mr-2" /> Novo associado
                  </h3>
                </div>
              </div>
            </div>
    ...
    >
      ...
      <div ref="modal_confirmation" class="vld-parent">
        <div class="py-3 text-center">
          ...
          <p class="mt-3 mb-0">
            ...
            <span class="font-weight-bold">associado</span> do portal.
          </p>
          <p class="mt-3">
            Por favor, digite
      ...
      <template slot="footer">
        ...
        <base-button
          ...
          @click="handleSubmitNewAssociado"
        >
          Confirmar criação
        </base-button>
      </template>
...
export default {
  ...
  computed: {
    isValidModel() {
      ...
      const associado = this.model.associado;
      for (const key of this.requiredFields) {
        if (associado[key] === "") return false;
      }
      return true;
    },
    passwordStatus() {
  ...
  methods: {
    ...
    async handleSubmitNewAssociado(e) {
      e.preventDefault();
      ...
      const associado = this.model.associado;
      try {
        await api.post("/admin/associates", {
          ...this.model.user,
          password_confirmation: this.model.user.password,
          ...associado,
        });
        this.$toasted.show("Novo associado cadastradro com sucesso");
        this.$router.push("/diretoria/usuarios/associados");
      } catch (e) {
        const genericError = "Ocorreu um erro ao cadastrar o associado.";
