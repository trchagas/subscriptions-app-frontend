        ...
        <div class="row">
          ...
          <div class="col-lg-7 col-md-10">
            <p class="text-white mt-4 mb-2">
              Aqui você poderá visualizar as informações de usuário do parceiro,
              o que inclui ver dados de usuário, foto de perfil e histórico de
              mensalidades.
            </p>
          </div>
        </div>
              ...
              <div class="row align-items-center">
                ...
                <div class="col">
                  <base-button
                    ...
                    @click="
                      $router.push(
                        `/diretoria/usuarios/parceiros/${model.parceiro.user_id}/editar`
                      )
                    "
                  >
              ...
              <form ref="parceiro_form" role="form" class="vld-parent">
                ...
                <div class="row ml-lg-2">
                  ...
                  <div class="col-lg-6">
                    ...
                    <p>
                      {{ formatPhone(model.parceiro.phone) }}
                    </p>
                  </div>
                </div>
                <hr class="mt-2 mb-4" />
                        ...
                        >
                          ...
                          <tbody class="list">
                            ...
                            >
                              <tr :key="index">
                                <td>
                                  {{ scopedFormatDate(row.month, row.year) }}
                                </td>
                                <td>
                                ...
                                <td>
                                  <i
                                    ...
                                    @click="
                                      $router.push(
                                        `/diretoria/mensalidades-parceiro/${row.payment_id}/visualizar`
                                      )
                                    "
                                  />
                                  <i
...
export default {
  ...
  methods: {
    ...
    async handleEditPayment() {
      ...
      try {
        await api.put(
          `admin/partner-payments/${this.modalEdit.payment_id}/partners/${this.model.parceiro.user_id}`,
    ...
    async handleSubmitRemove() {
      ...
      try {
        await api.delete(
          `admin/partner-payments/${this.modalRemove.payment_id}/partners/${this.model.parceiro.user_id}`
        );
    ...
    async loadMensalidades(page) {
      ...
      try {
        ...
        const { data } = await api.get(
          `/admin/partners/${this.model.parceiro.user_id}/payments?page=${page}&limit=${limit}`
        );
    ...
    scopedFormatDate(month, year) {
      return `${this.meses[month]} de ${year}`;
    },
    formatPhone(phone) {
      let format = phone;
