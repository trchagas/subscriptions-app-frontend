        ...
        <div class="row">
          <div class="col-12 mt-0 mt-md-4 mt-lg-0 d-block">
            <router-link
              ...
              title="Voltar para a listagem de questionários"
            >
          ...
          <div class="col-lg-7 col-md-10">
            <p class="text-white my-3">
              Aqui você pode construir novos questionários, que serão
              disponibilizadas para os usuários quando aplicável. Os usuários
              que acessarem o questionário poderão submeter suas respostas para
              as perguntas definidas abaixo.
            </p>
          </div>
        </div>
      </div>
          ...
          <card shadow>
            <div slot="header" class="bg-white border-0">
              <div class="row align-items-center">
                <div class="col-12">
                  <h3 class="mb-0">
                    <i class="fas fa-list-alt mr-2" /> Novo questionário
                  </h3>
                </div>
              </div>
            </div>
            <div ref="form_container" class="vld-parent">
              ...
              <div class="row ml-lg-2">
                ...
                <div class="col-lg-6">
                  <label class="form-control-label d-block mb-3">
                    ...
                    <i
                      v-tooltip="
                        'Se selecionado, o colaborador poderá optar por ocultar os <b>dados de identificação</b> ao responder o questionário. Uma vez definida, essa opção <b>não</b> poderá ser alterada futuramente.'
                      "
                      class="fas fa-info-circle ml-1"
                    />
                  </label>
                  <base-input>
                    <base-switch
                      :value="model.allow_anonymous_responses"
                      @input="
              ...
              <hr class="mt-2 mb-4" />
              <div class="row ml-1">
                <h6 class="heading-small text-muted">Permissões de acesso</h6>
              </div>
              ...
              >
                ...
                <div class="row">
                  <div class="col-lg-6 qf-container-edditable mb-2 mb-lg-0">
                    <quill-editor
              ...
              <div class="row">
                ...
                <div class="col-12 text-center mt-3">
                  <span
                    v-tooltip="
                      isValidModel
                        ? 'Clique para criar o questionário'
...
export default {
  ...
  watch: {
    ...
    aluno() {
      ...
      const newStudent = this.alunos.find((p) => p.value === this.aluno);
      this.participantes = [...this.participantes, newStudent];
      this.alunos = this.alunos.filter((p) => p.value !== newStudent.value);
      this.aluno = null;
    },
    associado() {
  ...
  async mounted() {
    ...
    try {
      const { data } = await api.get("/admin/surveys/users");
  ...
  methods: {
      ...
      try {
        ...
        survey.questions.forEach((question) => {
          if (question.type && question.label) {
            ...
            const isValid = ["selectbox", "checkbox"].includes(question.type);
            const validOptions = question.select_options.map(
              (select_option) => select_option.option
            );
            validQuestion.select_options = isValid ? validOptions : [];
        ...
        await api.post("/admin/surveys", {
          ...
          allow_anonymous_responses: survey.allow_anonymous_responses,
          description: survey.description,
          start_date: survey.start_date,
          end_date: survey.end_date,
          questions: validQuestions,
          is_public: survey.is_public,
          categories_ids: survey.categories_ids,
        ...
        this.$toasted.show("Novo questionário cadastrada com sucesso");
    ...
    handleRemoveSelectOption(questionIndex, optionIndex) {
      this.model.questions[questionIndex].select_options.splice(optionIndex, 1);
    },
    handleRemoveQuestion(index) {
      this.model.questions.splice(index, 1);
    },
    handleAddNewOption(index) {
      this.model.questions[index].select_options.push({ option: "" });
    },
...
.qf-container-edditable .quill-editor .ql-container,
.qf-container-edditable .quill-editor .ql-container .ql-editor {
  min-height: 3rem;
  width: 100%;
}
