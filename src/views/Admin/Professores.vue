        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-md-10">
            <p class="text-white mt-3 mb-5">
              Aqui você pode gerenciar os professores cadastrados.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="row text-center mt-1 mb-6">
        <div class="col-12">
          <base-button
            ...
            size="sm"
            type="primary"
            @click="$router.push('/diretoria/usuarios/professores/novo')"
          >
...
import TeacherCard from "./Professores/TeacherCard.vue";
