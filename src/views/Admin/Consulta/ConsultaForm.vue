        ...
        <div class="row">
          ...
          <div class="col-lg-7 col-md-10">
            <p class="text-white mt-4 mb-2">
              Aqui é possível registrar uma novo atendimento. Após o cadastro
              inicial, é possível atualizar as informações necessárias.
            </p>
          </div>
        </div>
      </div>
    ...
    >
      ...
      <template slot="footer">
        ...
        <base-button
          ...
          @click="handleSubmitNewAppointment"
        >
          Confirmar criação
        </base-button>
      </template>
...
export default {
  ...
  methods: {
    ...
    async handleSubmitNewAppointment(e) {
      e.preventDefault();
      const loader = this.$loading.show({
      ...
      try {
        await api.post("/admin/appointments", model);
        this.$toasted.show("Novo atendimento registrada com sucesso");
